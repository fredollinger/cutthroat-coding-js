...
describe('TestInsertSort5', function() {
    var arr = [4, 2, 7, 1, 3];
    var expected = [ 1, 2, 3, 4, 7 ];
    var res = sorting.InsertSort5(arr);
    console.log("TestInsert5: " + res);

    it('Insert Sort 5', function(){
        assert(helper.ArraysAreEqual(res, expected));
    });
...
describe('TestInsertSort6', function() {
    ...
    console.log("TestInsert6: res      " + res);
    console.log("TestInsert6: expected " + expected);
...
describe('TestInsertSort7', function() {
    var arr = [7, 6, 5, 4, 3, 2, 1];
    var expected = [1, 2, 3, 4, 5, 6, 7];
